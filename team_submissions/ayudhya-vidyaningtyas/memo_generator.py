...
Return JSON with these sections (detailed paragraphs, NO bullet points):

1. business_overview: 300 words. What company does, revenue streams, products, competitors, market position
2. industry_overview: 300 words. Industry trends, competitive dynamics, regulatory environment
3. investment_thesis: 200 words. Why {val['rating']} rating, valuation justification
4. valuation_methodology: 200 words. Explain 70% P/E + 20% Quality + 10% DCF
...
8. industry_dynamics: 300 words. Macro context, geopolitical, rate cuts, sustainability
9. sustainability_outlook: 200 words. ESG factors, carbon neutrality (100-150 words)
